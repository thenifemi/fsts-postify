...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/nifemi/Work/fetchly/fsts-postify/prisma/src/server/prisma/generated",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/Users/nifemi/Work/fetchly/fsts-postify/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": "../../../../../.env",
  ...
  "inlineSchemaHash": "1ed53a66c260249003e8e1016eb19c9f92dc00ac3acdce267d945bb2ae204a01",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "prisma/src/server/prisma/generated",
...
path.join(process.cwd(), "prisma/src/server/prisma/generated/libquery_engine-darwin-arm64.dylib.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma/src/server/prisma/generated/schema.prisma")
